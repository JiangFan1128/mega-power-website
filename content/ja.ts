...
export const ja: SiteContent = {
  ...
  scenarios: {
    ...
    hero: {
      title: "エネルギーシナリオを、導入可能なシステムへ",
      subtitle:
        "MEGA POWER はまず顧客の運用環境を見ます。系統条件、土地制約、信頼性要件、充電需要、サービス期待から設計を始めます。",
    },
    intro: {
      label: "Scenario Logic",
      title: "顧客環境を先に捉え、その後でシステムを構成",
      body:
        "各用途の圧力点を先に説明し、その後に蓄電、充電、デジタル監視、サービスを組み合わせた MEGA POWER の対応を示します。",
    },
    details: [
    ...
    cta: {
      label: "Next Step",
      title: "シナリオ理解からソリューション設計へ",
      body: "5 つのソリューション体系と、それを支える製品群を確認できます。",
      action: { label: "ソリューションを見る", page: "solutions" },
    },
  },
  solutions: {
    metadata: {
    ...
    hero: {
      title: "5 つのソリューション体系、1 つの統合ロジック",
      subtitle:
        "MEGA POWER のソリューション設計は、コア製品、デジタル管理、運用支援を横断して接続します。",
    },
    intro: {
      label: "Solution Framework",
      title: "運用条件から設計し、モジュール能力で拡張",
      body:
        "各ソリューションは、変換、蓄電、制御、警報、監視、サービスを一体の導入モデルとして構成します。",
    },
    items: [
    ...
    cta: {
      label: "Products",
      title: "各ソリューションを支える製品群を見る",
      body: "製品ページでは、PDF 由来の実モデルを導入役割ごとに整理しています。",
