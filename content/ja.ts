...
export const ja: SiteContent = {
  ...
  footer: {
    summary:
      "MEGA POWER TECHNOLOGY は蓄電、充電、デジタル制御、長期保守を一体化したグリーンエネルギー運用システムを提案します。",
    address: "〒102-0084 東京都千代田区二番町1-2 番町ハイム637-B",
    note:
      "MEGA POWER TECHNOLOGY はシステム設計、デジタル制御、長期サポートを一体で提供するエネルギーパートナーです。",
  },
  home: {
    metadata: {
      title: "MEGA POWER TECHNOLOGY | 統合型デジタル・グリーンエネルギーソリューション",
      description:
        "シナリオ起点で、系統用蓄電、調頻、光储充一体、デジタルプラットフォーム、安全性、日本市場対応力を伝える MEGA POWER TECHNOLOGY 企業サイト。",
    },
    hero: {
      eyebrow: "MEGA POWER TECHNOLOGY",
      title: "グローバルな持続可能エネルギー開発を推進",
      subtitle:
        "MEGA POWER TECHNOLOGY は太陽光、柔軟な蓄電、高効率充電、インテリジェント管理を統合し、系統、産業、輸送、充電インフラに向けたデジタル・グリーンエネルギーソリューションを提供します。",
    ...
    value: {
      ...
      body:
        "MEGA POWER TECHNOLOGY は単体ハードウェア以上を求める顧客向けに設計されています。電力変換、蓄電、充電、デジタル監視、警報、O&M ロジックを統合し、導入・運用・拡張しやすいシステムを構築します。",
    },
    scenarios: {
      label: "Scenarios",
      title: "運用シナリオから最適なソリューションの方向性を見つける",
      body:
      ...
      items: [
        {
          ...
          approach:
        "MEGA POWER TECHNOLOGY は蓄電とデジタルディスパッチ機能を組み合わせることで、システム柔軟性、電力品質、再エネ連系性能の向上を支えます。",
        ...
        },
        {
          ...
          approach:
        "同社の蓄電ベース調頻能力は、より高速な電力応答を支え、システム安定性と補助サービス性能の強化に役立ちます。",
        ...
        },
        {
          ...
          approach:
        "光储充一体システムにより、MEGA POWER TECHNOLOGY は制約条件下でもより柔軟な高出力充電導入を支援し、信頼性や施工効率が重要な現場に適合します。",
        ...
        },
        {
          ...
          approach:
        "同社の可搬型エネルギーシステムは、より迅速な展開と柔軟な電力供給を可能にし、レジリエンスと早期復旧を重視する案件に適しています。",
        ...
        },
        {
          ...
          approach:
        "同社の C&I 蓄電ソリューションは、負荷プロファイルを最適化し、エネルギー柔軟性を高め、重要運転条件での電力安定性を強化します。",
    ...
    solutions: {
      ...
      body:
        "MEGA POWER TECHNOLOGY は系統用蓄電、調頻、光储充一体、可搬型エネルギー、C&I 蓄電までを一つの体系で提供します。",
      items: [
    ...
    platform: {
      ...
      body:
        "このプラットフォームは、警報、追跡性、監視、ディスパッチ、保守フローを接続し、ライフサイクル全体の透明性と応答性を高めます。",
      bullets: [
        "電池警報と状態認識",
        "イベント追跡と記録",
        "エネルギー管理と制御",
    ...
    safety: {
      ...
      body:
        "MEGA POWER TECHNOLOGY は、安全性を単独の訴求ではなく、ハード、警報、記録、保守性を一体化した運用設計として組み込みます。",
    ...
    services: {
      ...
      body:
        "同社はサービスを運用能力の一部として捉え、ローカル対応体制、予防保全、顧客教育、予備品準備、パートナー連携を長期プロジェクト継続の観点から整えています。",
      items: [
        { title: "ローカル対応のサービス構造", body: "地域市場の理解、案件ごとの実行体制、パートナー連携を前提に、遠隔依存ではないサービス提供を組み立てています。" },
        { title: "緊急対応の導線", body: "7×24 の緊急対応体制により、高優先度の障害に対する初動を早め、停止時間の短縮を図ります。" },
  ...
  scenarios: {
    metadata: {
      title: "導入シナリオ | MEGA POWER TECHNOLOGY",
      description:
        "系統連系、調頻、弱系統充電、C&I 最適化、非常電源、日本市場向け導入要件を整理したシナリオページ。",
    },
    hero: {
      title: "運用シナリオから最適なソリューションを見つける",
      subtitle:
    ...
    intro: {
      ...
      title: "運用課題から最適なソリューション判断へ進む",
      body:
        "以下の各シナリオでは、運用課題に対して推奨ソリューション構成、代表製品、プラットフォーム機能、安全ロジック、サービス準備を一続きで確認できます。",
    },
    ...
    panels: [
      {
        ...
        solutionLabel: "推奨ソリューション",
        solutionTitle: "系統側エネルギー貯蔵ソリューション",
        solutionBody:
          "MEGA POWER TECHNOLOGY は系統側または発電側に MW 級蓄電を配置し、時間軸でエネルギーを移しながらデジタルディスパッチと連携して、出力平滑化、ピークシフト、系統支援、再エネ消納向上を実現します。",
      ...
      },
      {
        ...
        solutionBody:
          "MEGA POWER TECHNOLOGY は蓄電変換、高速制御、イベント追跡性を組み合わせ、より速い応答、より精密な追従、より安定した補助サービス価値を実現します。",
      ...
      },
      {
        ...
        solutionBody:
          "MEGA POWER TECHNOLOGY は AC / DC 結合のシステム設計で、太陽光、蓄電、充電を一つのマイクログリッドとして統合し、弱系統・無電源・狭小地でも高出力充電をより柔軟に実現します。",
      ...
      },
      {
        ...
        solutionBody:
          "MEGA POWER TECHNOLOGY はコンテナ、トレーラー、車両型のエネルギーシステムを用い、迅速な電力展開を実現します。耐振動設計、液冷、モジュール型運用により、移動用途にも対応します。",
      ...
      },
      {
        ...
        solutionBody:
          "MEGA POWER TECHNOLOGY はキャビネット単位から複数 MWh クラスまで柔軟に構成でき、負荷最適化、バックアップ強化、低炭素化に向けた制御可能な運用を支えます。",
      ...
      },
      {
        ...
        solutionBody:
          "同社は、コンパクト統合設計、信頼性重視のシステム思想、透明なデジタル監視、長期運用を支えるサービスコミュニケーションを通じて、日本向けの運用安心感を形成します。",
    ...
    details: [
      { title: "系統・再エネ連系", problem: "再エネ案件では、安定性、制御性、需給柔軟性が求められます。", approach: "MEGA POWER TECHNOLOGY は蓄電とデジタル制御を組み合わせ、系統側・発電側双方の用途を支えます。", benefits: ["再エネ導入率向上", "ピークシフト対応", "柔軟性向上", "系統支援強化"] },
      { title: "調頻・系統安定化", problem: "周波数制御には極めて高速かつ高精度な電力調整が必要です。", approach: "同社は蓄電ベースの調頻能力で安定した系統応答を支えます。", benefits: ["高速応答", "精密制御", "双方向調整", "運用価値向上"] },
      { title: "弱系統・狭小地の EV 充電", problem: "充電需要は系統容量や敷地条件をすぐに上回ります。", approach: "MEGA POWER TECHNOLOGY は蓄電、充電、デジタル監視を一体化し、柔軟な充電導入を実現します。", benefits: ["系統増強圧力の低減", "需要ピーク平準化", "モジュール展開", "充電継続性向上"] },
      { title: "C&I コスト最適化", problem: "産業・商業ユーザーはコスト低減と安定運用の両立を必要とします。", approach: "同社は蓄電によるエネルギー最適化と制御可能な電力支援を提供します。", benefits: ["ピーク需要抑制", "エネルギー柔軟性向上", "継続性強化", "低炭素化支援"] },
      { title: "オフグリッド・非常・仮設電源", problem: "遠隔地や緊急現場では恒久系統が利用できない場合があります。", approach: "MEGA POWER TECHNOLOGY は可搬型システムで迅速立上げと柔軟な給電を実現します。", benefits: ["迅速導入", "現場適応性", "移動電源支援", "レジリエントな非常対応"] },
      { title: "日本市場特有の導入要件", problem: "日本では敷地制約、信頼性、保守性に関する調整がより厳しく求められます。", approach: "同社はコンパクト統合、運用安心感、コミュニケーション信頼、支援体制を重視して日本向け導入を設計します。", benefits: ["狭小地適合", "信頼性重視計画", "保守しやすい長期運用", "明確なコミュニケーション"] },
    ],
    japanBlock: {
    ...
    mapping: {
      ...
      body:
        "同社は機器、ソフトウェア、O&M を分離せず、製品、デジタル機能、サービス運用を一つの仕組みとして提案します。",
  ...
  solutions: {
    metadata: {
      title: "ソリューション | MEGA POWER TECHNOLOGY",
      description:
  ...
  platform: {
    metadata: {
      title: "プラットフォーム | MEGA POWER TECHNOLOGY",
      description:
        "警報、追跡性、監視、制御、O&M フロー、データ安全性を扱うデジタルプラットフォームページ。",
    },
    hero: {
    ...
    intro: {
      ...
      body:
        "長期の業界データ蓄積とローカルリアルタイム処理を基盤に、同社は従来の蓄電アーキテクチャへ安全強化レイヤーを加え、業界の主要課題に対応します。",
    },
    capability: {
      ...
      explainer: {
        label: "6S + EDR とは",
        body:
        "ここでいう 6S は、このアーキテクチャを構成する 6 つの中核システム層、すなわち BWS、HCS、PCS、BMS、EMS、OMS を指します。EDR はイベント記録と故障追跡を担い、6S+EDR の安全アーキテクチャを完成させます。",
        systems: [
    ...
    management: {
      ...
      body:
        "MEGA POWER TECHNOLOGY は、イベント記録、戦略ディスパッチ、監視、警報、O&M 実行を一つのデジタル運用レイヤーに統合し、規模の異なる蓄電システムに対応します。",
    ...
    security: {
      ...
      body:
        "同社は、小規模・中規模・大規模案件に応じた EMS ローカル配備を支援し、データ収集、伝送、保存、アクセス制御、サーバ保護、監査管理まで多層の保護設計を整えています。",
      deployment: [
        "小規模配備：1MWh 未満",
        "中規模配備：1MWh から 5MWh",
        "大規模配備：5MWh 超",
  ...
  products: {
    metadata: {
      title: "製品 | MEGA POWER TECHNOLOGY",
      description:
    ...
    hero: {
      ...
      subtitle:
        "導入役割ごとに主要製品ファミリーを比較し、モデル、主要仕様、適用シーンを把握できます。",
      highlight: "中核製品",
    },
    intro: {
    ...
    related: {
      ...
      title: "製品ファミリーを通じて、ソリューション全体の構成を確認",
      body:
  ...
  safety: {
    metadata: {
      title: "安全性・信頼性 | MEGA POWER TECHNOLOGY",
      description:
    ...
    hero: {
      ...
      subtitle:
        "MEGA POWER TECHNOLOGY は、統合された安全ロジックと運用設計によって、不確実性を抑えた運用を支えます。",
      highlight: "追跡性",
    },
    intro: {
      ...
      body:
        "安全性は、電池警報、区画制御、イベント記録、防火連携、保守可視化を一体で捉えるシステム設計です。",
    },
    items: [
    ...
    japan: {
      ...
      body:
        "日本市場では、運用安心感、保守性、規律あるコミュニケーション、狭小地での長期安定運用を重視しています。",
  ...
  services: {
    metadata: {
      title: "サービス | MEGA POWER TECHNOLOGY",
      description:
    ...
    strategy: [
      { title: "ローカルサービスチームモデル", body: "同社は、市場理解と現地対応を前提にしたサービス体制を構築します。" },
      { title: "異文化コミュニケーショントレーニング", body: "国際協業の品質と信頼形成を支える要素です。" },
      { title: "継続的技術支援と更新", body: "同社は、導入後も継続する技術支援と更新を長期運用の前提として重視します。" },
      { title: "パートナーネットワーク拡張", body: "現地パートナーを通じて対応力とカバレッジを高めます。" },
    ],
    mechanism: [
      { title: "障害時の緊急対応", body: "7×24 の緊急ホットライン体制により、緊急時のアフターサービス対応を迅速に行います。" },
      { title: "予防保全", body: "定期点検と予防保全で障害リスクを下げ、継続運用を支えます。" },
      { title: "顧客教育と支援", body: "オンライン・現地教育で誤操作由来の負荷を減らします。" },
      { title: "交換部品の迅速対応", body: "交換部品ネットワークにより、重要部品の修復時間短縮とサービス継続性向上を図ります。" },
    ],
    japan: {
      label: "",
      title: "",
    ...
    cta: {
      label: "About",
      title: "会社概要ページでは、サービス体制を含めた提供全体像を確認できます",
      body: "製品、プラットフォーム、導入支援、長期サービスを会社全体の提供価値として見たい場合は、About ページが次の入口になります。",
      action: { label: "About ページへ", page: "about" },
    },
  },
  about: {
    metadata: {
      title: "会社情報 | MEGA POWER TECHNOLOGY",
      description:
        "統合型デジタル・グリーンエネルギー企業としての位置付けとミッションを示す会社情報ページ。",
    },
    hero: {
      title: "会社概要",
      subtitle:
    ...
    intro: {
      ...
      title: "単なるハードウェア企業ではなく、統合ソリューションプロバイダー",
      body:
        "MEGA POWER TECHNOLOGY は、統合エネルギー設計、デジタル運用能力、サービス準備を組み合わせて、より完成度の高いソリューションを提供します。",
    },
    pillars: [
      ...
      { title: "運用支援志向", body: "長期保守性とローカル対応により、導入後も安定した運用を支えます。" },
    ],
    japan: {
      label: "",
      title: "",
  ...
  contact: {
    ...
    intro: {
      ...
      title: "会社情報",
      body: "案件相談やビジネスコミュニケーションに必要な基本情報をご確認いただけます。",
    },
    items: [
    ...
    note:
      "追加の連絡先が必要な場合は、案件調整の過程で担当チームより個別にご案内します。",
    mapEmbed:
