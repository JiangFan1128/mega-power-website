...
export const zh: SiteContent = {
  ...
  scenarios: {
    ...
    hero: {
      title: "把能源场景转化为可部署系统",
      subtitle:
        "MEGA POWER 先从客户运行环境出发，再谈方案：电网条件、用地限制、可靠性要求、充电需求和服务期待。",
    },
    intro: {
      label: "Scenario Logic",
      title: "先理解客户环境，再设计系统架构",
      body:
        "本页先说明各类场景背后的运行压力，再呈现 MEGA POWER 在储能、充电、数字监控与服务上的综合应对方式。",
    },
    details: [
    ...
    cta: {
      label: "Next Step",
      title: "从场景理解进入方案架构",
      body: "继续查看五大解决方案体系及其对应产品族。",
      action: { label: "查看解决方案", page: "solutions" },
    },
  },
  solutions: {
    metadata: {
    ...
    hero: {
      title: "五大解决方案体系，一套综合逻辑",
      subtitle:
        "MEGA POWER 将核心产品、数字化管理与运营支持连接起来，服务于电网、工业、交通与充电场景。",
    },
    intro: {
      label: "Solution Framework",
      title: "从运行条件出发，用模块化能力完成扩展",
      body:
        "每个方案族都把变流、储能、控制、预警、监控与服务逻辑整合为一套部署模型。",
    },
    items: [
    ...
    cta: {
      label: "Products",
      title: "查看支撑方案体系的产品族",
      body: "产品页以源 PDF 的真实型号为基础，按系统角色与场景适配进行组织。",
